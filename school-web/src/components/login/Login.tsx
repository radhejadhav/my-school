...
interface CredetnialObjectType {
  username: string;
  password: string;
}

const credentialDefaultValue:CredetnialObjectType = {
    username:"",
    password:""
}

const Login: React.FC = () => {
  const [credential, setCredentials] = useState<CredetnialObjectType>(credentialDefaultValue);
